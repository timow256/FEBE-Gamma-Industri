// // routes/reset.js - update to only reset product counts
...
//     // Create a new record with reset product counts but preserve other data
//     const newData = await new SensorData({
//       // Preserve existing sensor values
//       vibration_level: latestData ? latestData.vibration_level : 0,
